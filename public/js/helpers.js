            ...
            $(document).ready(function(){
                ...
                function getDataDefault(){
                    ...
                    var goTo = "http://localhost/~joakopino/skyDefinetly/rest_api/data_from/" + timestampOneHourAgo;
                ...
                setTimeout(function(){
                    ...
                    if (cpu_data.length==0 && concurrency_data==0)
                      alert("There are not data to display");
                    else{
                ...
                $("#more_data").submit(function(e) {
                    ...
                    if (numberNewRecords){
                      $.ajax({
                                  url: "http://localhost/~joakopino/skyDefinetly/rest_api/new_records/",
                                  type: "post",
                        ...
                        alert("Peticion vacia : " + numberNewRecords);
                ...
                $("#get_max_data").submit(function(e) {
                  ...
                  //Building the path where the webservices is going to give the data since one hour ago until now
                  var goTo = "http://localhost/~joakopino/skyDefinetly/rest_api/max_data_time_slot/" + column_to_search +"/"+timestampFrom+"/"+timestampTo;
                ...
                $("#get_avg_data").submit(function(e) {
                  ...
                  //Building the path where the webservices is going to give the data since one hour ago until now
                  var goTo = "http://localhost/~joakopino/skyDefinetly/rest_api/average_data_time_slot/" + column_to_search +"/"+timestampFrom+"/"+timestampTo;
